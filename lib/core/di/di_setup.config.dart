...
import '../../presentation/process/bloc/process_bloc.dart' as _i42;
import '../../presentation/profile/bloc/logged_in_cubit.dart' as _i6;
import '../../presentation/profile/bloc/profile_bloc.dart' as _i43;
import '../../presentation/search/bloc/engine_info_cubit.dart' as _i41;
...
import '../../presentation/task/bloc/task_bloc.dart' as _i44;
import '../../presentation/task/bloc/task_detail/task_detail_cubit.dart'
    as _i16;
import '../../presentation/task_activity/bloc/upload_file_bloc.dart' as _i45;
...
Future<_i1.GetIt> $initGetIt(
  ...
  gh.factory<_i36.UploadFileRemoteDataSource>(
      () => _i37.UploadFileRemoteDataSourceImpl(gh<_i18.UploadFileService>()));
  gh.factory<_i38.UploadFileRepository>(() =>
      _i39.UploadFileRepositoryImpl(gh<_i36.UploadFileRemoteDataSource>()));
  gh.factory<_i40.ConnectivityBloc>(
      () => _i40.ConnectivityBloc(gh<_i21.EngineInfoRepository>()));
  gh.factory<_i41.EngineInfoCubit>(
      () => _i41.EngineInfoCubit(gh<_i21.EngineInfoRepository>()));
  gh.factory<_i42.ProcessBloc>(
      () => _i42.ProcessBloc(gh<_i26.ProcessRepository>()));
  gh.factory<_i43.ProfileBloc>(
      () => _i43.ProfileBloc(gh<_i30.ProfileRepository>()));
  gh.factory<_i44.TaskBloc>(() => _i44.TaskBloc(gh<_i34.TaskRepository>()));
  gh.factory<_i45.UploadFileBloc>(
      () => _i45.UploadFileBloc(gh<_i38.UploadFileRepository>()));
  return getIt;
}
