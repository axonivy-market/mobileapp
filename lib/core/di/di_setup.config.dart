...
import '../../features/process/domain/usecases/get_processes_use_case.dart'
    as _i38;
import '../../features/process/presentation/bloc/process_bloc.dart' as _i41;
...
import '../../features/task/domain/repositories/task_repository_interface.dart'
    as _i32;
import '../../features/task/domain/usecases/delete_file_use_case.dart' as _i36;
import '../../features/task/domain/usecases/get_task_use_case.dart' as _i40;
import '../../features/task/domain/usecases/get_tasks_use_case.dart' as _i39;
import '../../features/task/domain/usecases/upload_file_use_case.dart' as _i35;
...
Future<_i1.GetIt> $initGetIt(
  ...
  gh.factory<_i30.TaskActivityBloc>(
      () => _i30.TaskActivityBloc(gh<_i14.HiveTaskStorage>()));
  gh.factory<_i31.TaskRemoteDataSource>(
      () => _i31.TaskRemoteDataSource(gh<_i4.Dio>()));
  gh.factory<_i32.TaskRepositoryInterface>(
      () => _i33.TaskRepositoryImplement(gh<_i31.TaskRemoteDataSource>()));
  gh.factory<_i34.UploadFileBloc>(() => _i34.UploadFileBloc(
        gh<_i10.FileRepositoryInterface>(),
        gh<_i14.HiveTaskStorage>(),
      ));
  gh.factory<_i35.UploadFileUseCase>(() =>
      _i35.UploadFileUseCase(repository: gh<_i10.FileRepositoryInterface>()));
  gh.factory<_i36.DeleteFileUseCase>(() =>
      _i36.DeleteFileUseCase(repository: gh<_i10.FileRepositoryInterface>()));
  gh.factory<_i37.EngineInfoCubit>(
      () => _i37.EngineInfoCubit(gh<_i13.GetEngineInfoUseCase>()));
  gh.factory<_i38.GetProcessesUseCase>(() => _i38.GetProcessesUseCase(
      repository: gh<_i19.ProcessRepositoryInterface>()));
  gh.factory<_i39.GetTaskListUseCase>(() =>
      _i39.GetTaskListUseCase(repository: gh<_i32.TaskRepositoryInterface>()));
  gh.factory<_i40.GetTaskUseCase>(() =>
      _i40.GetTaskUseCase(repository: gh<_i32.TaskRepositoryInterface>()));
  gh.factory<_i41.ProcessBloc>(
      () => _i41.ProcessBloc(gh<_i38.GetProcessesUseCase>()));
  gh.factory<_i42.ProfileBloc>(
      () => _i42.ProfileBloc(gh<_i22.ProfileRepositoryInterface>()));
  gh.factory<_i43.TaskBloc>(() => _i43.TaskBloc(
        gh<_i39.GetTaskListUseCase>(),
        gh<_i14.HiveTaskStorage>(),
        gh<_i35.UploadFileUseCase>(),
        gh<_i36.DeleteFileUseCase>(),
      ));
  gh.factory<_i44.TaskDetailBloc>(() => _i44.TaskDetailBloc(
        gh<_i40.GetTaskUseCase>(),
        gh<_i14.HiveTaskStorage>(),
      ));
  gh.factory<_i45.ToastMessageCubit>(
      () => _i45.ToastMessageCubit(gh<_i40.GetTaskUseCase>()));
  gh.factory<_i46.DeleteFileBloc>(() => _i46.DeleteFileBloc(
        gh<_i36.DeleteFileUseCase>(),
        gh<_i14.HiveTaskStorage>(),
      ));
  return getIt;
