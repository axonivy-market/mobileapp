...
import '../../features/search/presentation/bloc/search_filter_cubit/search_filter_cubit.dart'
    as _i23;
import '../../features/splash/splash_cubit.dart' as _i26;
import '../../features/tabbar/bloc/connectivity_bloc/connectivity_bloc.dart'
    as _i33;
import '../../features/tabbar/bloc/tabbar_cubit.dart' as _i27;
...
import '../../features/task/domain/usecases/upload_file_use_case.dart' as _i32;
...
import '../../features/task/presentation/bloc/offline_indicator_cubit/offline_indicator_cubit.dart'
    as _i15;
import '../../features/task/presentation/bloc/sort_bloc/sort_bloc.dart' as _i25;
...
Future<_i1.GetIt> $initGetIt(
  ...
  gh.factory<_i5.EngineInfoRemoteDataSource>(
      () => _i5.EngineInfoRemoteDataSource(gh<_i3.Dio>()));
  gh.factory<_i6.EngineInfoRepositoryInterface>(() =>
      _i7.EngineInfoRepositoryImplement(gh<_i5.EngineInfoRemoteDataSource>()));
  gh.factory<_i8.FileRemoteDataSource>(
      () => _i8.FileRemoteDataSource(gh<_i3.Dio>()));
  gh.factory<_i9.FileRepositoryInterface>(
      () => _i10.FileRepositoryImplement(gh<_i8.FileRemoteDataSource>()));
  gh.factory<_i11.FilterBloc>(() => _i11.FilterBloc());
  gh.factory<_i12.GetEngineInfoUseCase>(() => _i12.GetEngineInfoUseCase(
      repository: gh<_i6.EngineInfoRepositoryInterface>()));
  gh.factory<_i13.LoggedInCubit>(() => _i13.LoggedInCubit());
  gh.factory<_i14.LoginBloc>(
      () => _i14.LoginBloc(gh<_i6.EngineInfoRepositoryInterface>()));
  gh.factory<_i15.OfflineIndicatorCubit>(() => _i15.OfflineIndicatorCubit());
  gh.factory<_i16.ProcessRemoteDataSource>(
      () => _i16.ProcessRemoteDataSource(gh<_i3.Dio>()));
  gh.factory<_i17.ProcessRepositoryInterface>(() =>
      _i18.ProcessRepositoryImplement(gh<_i16.ProcessRemoteDataSource>()));
  gh.factory<_i19.ProfileRemoteDataSource>(
      () => _i19.ProfileRemoteDataSource(gh<_i3.Dio>()));
  gh.factory<_i20.ProfileRepositoryInterface>(() =>
      _i21.ProfileRepositoryImplement(gh<_i19.ProfileRemoteDataSource>()));
  gh.factory<_i22.SearchBloc>(() => _i22.SearchBloc());
  gh.factory<_i23.SearchFilterCubit>(() => _i23.SearchFilterCubit());
  await gh.factoryAsync<_i24.SharedPreferences>(
    () => appModule.prefs,
    preResolve: true,
  );
  gh.factory<_i25.SortBloc>(() => _i25.SortBloc());
  gh.factory<_i26.SplashCubit>(() => _i26.SplashCubit());
  gh.factory<_i27.TabBarCubit>(() => _i27.TabBarCubit());
  gh.factory<_i28.TaskRemoteDataSource>(
      () => _i28.TaskRemoteDataSource(gh<_i3.Dio>()));
  gh.factory<_i29.TaskRepositoryInterface>(
      () => _i30.TaskRepositoryImplement(gh<_i28.TaskRemoteDataSource>()));
  gh.factory<_i31.UploadFileBloc>(
      () => _i31.UploadFileBloc(gh<_i9.FileRepositoryInterface>()));
  gh.factory<_i32.UploadFileUseCase>(() =>
      _i32.UploadFileUseCase(repository: gh<_i9.FileRepositoryInterface>()));
  gh.factory<_i33.ConnectivityBloc>(
      () => _i33.ConnectivityBloc(gh<_i6.EngineInfoRepositoryInterface>()));
  gh.factory<_i34.DeleteFileUseCase>(() =>
      _i34.DeleteFileUseCase(repository: gh<_i9.FileRepositoryInterface>()));
  gh.factory<_i35.EngineInfoCubit>(
      () => _i35.EngineInfoCubit(gh<_i12.GetEngineInfoUseCase>()));
  gh.factory<_i36.GetProcessesUseCase>(() => _i36.GetProcessesUseCase(
      repository: gh<_i17.ProcessRepositoryInterface>()));
  gh.factory<_i37.GetTaskListUseCase>(() =>
      _i37.GetTaskListUseCase(repository: gh<_i29.TaskRepositoryInterface>()));
  gh.factory<_i38.GetTaskUseCase>(() =>
      _i38.GetTaskUseCase(repository: gh<_i29.TaskRepositoryInterface>()));
  gh.factory<_i39.ProcessBloc>(
      () => _i39.ProcessBloc(gh<_i36.GetProcessesUseCase>()));
  gh.factory<_i40.ProfileBloc>(
      () => _i40.ProfileBloc(gh<_i20.ProfileRepositoryInterface>()));
