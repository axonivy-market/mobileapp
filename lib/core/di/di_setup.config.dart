...
import '../../features/profile/bloc/logged_in_cubit.dart' as _i32;
...
import '../../features/search/bloc/engine_info_cubit/engine_info_cubit.dart'
    as _i48;
import '../../features/search/bloc/search_bloc/search_bloc.dart' as _i13;
import '../../features/search/bloc/search_filter_cubit/search_filter_cubit.dart'
    as _i14;
import '../../features/splash/splash_cubit.dart' as _i17;
import '../../features/tabbar/bloc/connectivity_bloc/connectivity_bloc.dart'
    as _i46;
import '../../features/tabbar/bloc/tabbar_cubit.dart' as _i18;
...
import '../../features/task/presentation/bloc/offline_indicator_cubit/offline_indicator_cubit.dart'
    as _i10;
import '../../features/task/presentation/bloc/sort_bloc/sort_bloc.dart' as _i16;
...
Future<_i1.GetIt> $initGetIt(
  ...
  gh.factory<_i19.TaskLocalDataSource>(() => _i19.TaskLocalDataSource());
  ...
  gh.factory<_i32.LoggedInCubit>(
      () => _i32.LoggedInCubit(gh<_i19.TaskLocalDataSource>()));
  gh.factory<_i33.LoginBloc>(
      () => _i33.LoginBloc(gh<_i28.EngineInfoRepository>()));
  gh.factory<_i34.ProcessRemoteDataSource>(
      () => _i35.ProcessRemoteDataSourceImpl(gh<_i11.ProcessService>()));
  ...
  gh.factory<_i38.ProfileRemoteDataSource>(
      () => _i39.ProfileRemoteDataSourceImpl(gh<_i12.ProfileService>()));
  gh.factory<_i40.ProfileRepository>(
      () => _i41.ProfileRepositoryImpl(gh<_i38.ProfileRemoteDataSource>()));
  gh.factory<_i42.TaskActivityBloc>(
      () => _i42.TaskActivityBloc(gh<_i19.TaskLocalDataSource>()));
  ...
  gh.factory<_i46.ConnectivityBloc>(
      () => _i46.ConnectivityBloc(gh<_i28.EngineInfoRepository>()));
  gh.factory<_i47.DeleteFileBloc>(
      () => _i47.DeleteFileBloc(gh<_i25.DeleteFileUseCase>()));
  gh.factory<_i48.EngineInfoCubit>(
      () => _i48.EngineInfoCubit(gh<_i28.EngineInfoRepository>()));
  gh.factory<_i49.ProcessBloc>(
      () => _i49.ProcessBloc(gh<_i36.ProcessRepository>()));
  gh.factory<_i50.ProfileBloc>(
      () => _i50.ProfileBloc(gh<_i40.ProfileRepository>()));
  return getIt;
}
